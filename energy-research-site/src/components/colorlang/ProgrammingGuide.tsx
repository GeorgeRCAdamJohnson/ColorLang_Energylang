    ...
    >
      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        <div className="text-sm">
          <span className="font-mono font-semibold text-gray-900 dark:text-gray-100">{step.instruction}</span>
          {step.data !== undefined && <span className="text-gray-600 dark:text-gray-400"> (data: {step.data})</span>}
        </div>
      </div>
...
export function ProgrammingGuide() {
  ...
  return (
    <section className="mb-12">
          ...
          {!selectedTutorial ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {tutorials.map(tutorial => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">{tutorial.title}</h3>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">{selectedTutorial.title}</h3>
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">Tutorial Steps</h4>
      ...
      <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 border border-green-200 dark:border-green-800 rounded-lg">
        ...
        <div className="flex flex-wrap gap-4 text-sm">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-700 dark:text-gray-300">Start with simple LOAD → PRINT → HALT patterns</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 bg-blue-500 rounded-full"></div>
            <span className="text-gray-700 dark:text-gray-300">Use the step debugger to understand execution flow</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 bg-purple-500 rounded-full"></div>
            <span className="text-gray-700 dark:text-gray-300">Experiment with different color combinations</span>
          </div>
        </div>
      </div>
    </section>
