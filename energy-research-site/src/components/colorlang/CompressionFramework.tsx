    ...
    <div className="card">
      ...
      <div className="space-y-2 text-xs">
        ...
        <div className="flex justify-between">
          ...
          <span className="font-medium text-blue-600">{useCase}</span>
        </div>
    ...
    <section className="mb-12">
      ...
      <div className="mt-8 grid md:grid-cols-3 gap-6">
        <div className="card text-center">
          <Zap className="mx-auto mb-3 text-yellow-600" size={32} />
        ...
        <div className="card text-center">
          ...
          <h3 className="font-semibold text-gray-900 mb-2">Embedded Optimization</h3>
          <p className="text-sm text-gray-600">
        ...
        <div className="card text-center">
          <Layers className="mx-auto mb-3 text-green-600" size={32} />
          <h3 className="font-semibold text-gray-900 mb-2">Adaptive Algorithms</h3>
          <p className="text-sm text-gray-600">
      ...
      <div className="mt-8 p-6 bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-lg">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">Compression Pipeline</h3>
