...
export function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 section-padding overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="container-custom relative">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-green-100 to-purple-100 text-green-800 px-6 py-3 rounded-full text-sm font-semibold mb-8 border border-green-200/50 shadow-sm"
            >
              <TrendingUp size={16} />
            ...
            >
              <span className="block text-gray-900 mb-2">Groundbreaking Research in</span>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-4">
                ...
                <div className="text-center">
                  ...
                  <div className="flex items-center justify-center space-x-2">
                    ...
                    <span className="text-gray-600">vs Python</span>
                  </div>
                </div>
            ...
            >
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/50">
                ...
                <div className="text-sm text-gray-600">Energy Benchmarked</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/50">
                <div className="text-3xl font-bold text-purple-600 mb-2">2D</div>
                <div className="text-gray-700 font-medium">Visual Programming</div>
                <div className="text-sm text-gray-600">Color Field Innovation</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/50">
                <div className="text-3xl font-bold text-green-600 mb-2">100%</div>
                <div className="text-gray-700 font-medium">AI-Assisted Development</div>
                <div className="text-sm text-gray-600">With Rigorous Methodology</div>
              </div>
            </motion.div>
