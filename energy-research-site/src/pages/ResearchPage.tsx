...
function CollapsibleSection({
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-700 rounded-lg mb-6 overflow-hidden">
      ...
      {isOpen && <div className="px-6 py-6 bg-white dark:bg-gray-900">{children}</div>}
    </div>
  )
}
          ...
          >
            <div className="space-y-6 research-content" data-protected="true">
              ...
              <div>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/30 border-l-4 border-purple-400 dark:border-purple-500 p-4 rounded-r-lg">
          ...
          >
            <div className="space-y-6 research-content" data-protected="true">
              <div className="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700 p-4 rounded-lg">
                <h4 className="font-semibold text-red-900 dark:text-red-200 mb-2">The Problem</h4>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-red-50 dark:bg-red-900/30 p-3 rounded-lg">
                    <h6 className="font-medium text-red-900 dark:text-red-200 text-sm mb-1">
                      Before (Race Conditions)
                    </h6>
                    <p className="text-red-800 dark:text-red-300 text-sm">Variance: 200-300%</p>
                    <p className="text-red-800 dark:text-red-300 text-sm">Reliability: ~40%</p>
                  </div>
                  <div className="bg-green-50 dark:bg-green-900/30 p-3 rounded-lg">
                    <h6 className="font-medium text-green-900 dark:text-green-200 text-sm mb-1">
            ...
            <div className="space-y-6 research-content" data-protected="true">
              <div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 p-4 rounded-lg">
                    <h5 className="font-medium text-blue-900 dark:text-blue-200 mb-2">pyJoules</h5>
                    <ul className="text-sm text-blue-800 dark:text-blue-300 space-y-1">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  ...
                  relationship:
                  <strong className="font-mono bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-2 py-1 rounded mx-1">
                    Energy = Power × Time
                  </strong>
                </p>
